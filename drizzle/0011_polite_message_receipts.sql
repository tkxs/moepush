...
--> statement-breakpoint
CREATE INDEX `message_receipts_source_type_idx` ON `message_receipts` (`source_type`);
--> statement-breakpoint
CREATE INDEX `message_receipts_source_id_idx` ON `message_receipts` (`source_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `message_receipt_deliveries_user_id_idx` ON `message_receipt_deliveries` (`user_id`);
--> statement-breakpoint
CREATE INDEX `message_receipt_deliveries_target_id_idx` ON `message_receipt_deliveries` (`target_id`);
--> statement-breakpoint
